...
final class Version20231113135924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participant (id INT AUTO_INCREMENT NOT NULL, campus_id INT NOT NULL, mail VARCHAR(180) NOT NULL, roles JSON NOT NULL, mot_passe VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prã©nom VARCHAR(255) NOT NULL, telephone VARCHAR(255) DEFAULT NULL, administrateur TINYINT(1) NOT NULL, actif TINYINT(1) NOT NULL, pseudo VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D79F6B115126AC48 (mail), INDEX IDX_D79F6B11AF5D55E1 (campus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
